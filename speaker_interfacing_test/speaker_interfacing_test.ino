...
uint8_t const speaker_out = 9;
// Do we want debugging on serial out? 1 for yes, 0 for no
uint8_t const DEBUG = 1;
...
int const melody[] = {  C,  b,  g,  C,  b,   e,  R,  C,  c,  g, a, C };
int const beats[]  = { 16, 16, 16,  8,  8,  16, 32, 16, 16, 16, 8, 8 }; 
int const MAX_COUNT = sizeof( melody ) / 2; // Melody length, for looping.
...
int rest_count = 5; //<-BLETCHEROUS HACK; See NOTES
